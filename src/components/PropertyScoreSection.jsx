    ...
    <section className="score-teaser section-light" id="property-score">
      <div className="section-shell score-teaser-shell">
        <div className="score-teaser-copy" data-reveal>
          ...
          <p>
            Paste a public listing URL. StayDog will return a potential score, confidence level, opportunity notes,
            and recommended next steps before a human strategy review.
          </p>
